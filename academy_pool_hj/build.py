...
"IT":{
 ...
 "venturi_note":"Il manuale Balboa indica che l'uso di una pompa aria per 'boostare' i Freedom non e' raccomandato: la serie e' progettata per funzionare senza air pump.",
 "k4":"03 • POMPA REALE",
 ...
 "l6":"Questa e' l'architettura funzionale confermata nel progetto DB. E' un case study specifico, non una regola universale per tutte le piscine idromassaggio.",
